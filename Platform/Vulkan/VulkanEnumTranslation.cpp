...
vk::IndexType translate(GpuIndexType type)
{
    switch(type)
    {
...
vk::PipelineStageFlagBits translate(GpuPipelineStage stage)
{
    switch(stage)
    {
        case GpuPipelineStage::BEFORE_ALL_COMMANDS:
            return vk::PipelineStageFlagBits::eTopOfPipe;
        case GpuPipelineStage::VERTEX_INPUT:
            return vk::PipelineStageFlagBits::eVertexInput;
        case GpuPipelineStage::VERTEX_SHADER:
            return vk::PipelineStageFlagBits::eVertexShader;
        case GpuPipelineStage::GEOMETRY_SHADER:
            return vk::PipelineStageFlagBits::eGeometryShader;
        case GpuPipelineStage::FRAGMENT_SHADER:
            return vk::PipelineStageFlagBits::eFragmentShader;
        case GpuPipelineStage::EARLY_FRAGMENT_TESTS:
            return vk::PipelineStageFlagBits::eEarlyFragmentTests;
        case GpuPipelineStage::LATE_FRAGMENT_TESTS:
            return vk::PipelineStageFlagBits::eLateFragmentTests;
        case GpuPipelineStage::COLOR_ATTACHMENT_OUTPUT:
            return vk::PipelineStageFlagBits::eColorAttachmentOutput;
        case GpuPipelineStage::TRANSFER:
            return vk::PipelineStageFlagBits::eTransfer;
        case GpuPipelineStage::AFTER_ALL_COMMANDS:
            return vk::PipelineStageFlagBits::eBottomOfPipe;
        case GpuPipelineStage::HOST:
...
USAGI_ENUM_TRANSLATION_NS(usagi::vulkan, GpuBufferFormat, vk::Format, 14,
    (
        ...
        GpuBufferFormat::B8G8R8A8_UNORM,
